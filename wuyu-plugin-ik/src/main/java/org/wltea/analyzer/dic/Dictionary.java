...
public class Dictionary {
	...
	private void loadMainDict(){
		...
		//读取主词典文件
        System.out.println(cfg.getExtDictionarys() + "," + cfg.getMainDictionary());
        InputStream is = Dictionary.class.getClassLoader().getResourceAsStream(cfg.getMainDictionary());
        if(is == null){
